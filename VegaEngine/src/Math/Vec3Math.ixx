...
export Vec3<double> sph2cart(Vec3<double> rho_theta_phi) {
...
export Vec3<double> sph2cartr1(Vec3<double> rho_theta_phi) {
...
export Vec3<float> sph2cart(Vec3<float> rho_theta_phi) {
...
export Vec3<float> sph2cartr1(Vec3<float> rho_theta_phi) {
...
export Vec3<double> cart2sph(Vec3<double> xyz) {
...
export Vec3<double> cart2sphr1(Vec3<double> xyz) {
	Vec3<double> rho_theta_phi = Vec3(1.);
...
export Vec3<float> cart2sph(Vec3<float> xyz) {
...
export Vec3<float> cart2sphr1(Vec3<float> xyz) {
	Vec3<float> rho_theta_phi = Vec3(1.f);
	rho_theta_phi.y = std::acos(xyz.z);
	rho_theta_phi.z = std::atan2(xyz.y, xyz.x);
	return rho_theta_phi;
...
export Vec3<bool> Not(Vec3<bool> vec) {
	return Vec3((bool)(1 - vec.x), (bool)(1 - vec.y), (bool)(1 - vec.z));
}

export Vec3<bool> And(Vec3<bool> a, Vec3<bool> b) {
	return Vec3(a.x && b.x, a.y && b.y, a.z && b.z);
}

export Vec3<bool> Or(Vec3<bool> a, Vec3<bool> b) {
	return Vec3(a.x || b.x, a.y || b.y, a.z || b.z);
}

export Vec3<bool> Xor(Vec3<bool> a, Vec3<bool> b) {
	return Not(Vec3(a.x == b.x, a.y == b.y, a.z == b.z));
}

export Vec3<bool> NOr(Vec3<bool> a, Vec3<bool> b) {
	return Not(Or(a, b));
}

export Vec3<bool> NAnd(Vec3<bool> a, Vec3<bool> b) {
	return Not(And(a, b));
}

export Vec3<bool> NXor(Vec3<bool> a, Vec3<bool> b) {
	return Not(Xor(a, b));
}
