...
namespace Vega {
	...
	export class CRigidBody : public CTransform {
	public:
		...
		void AddTorque(Vec3<double> torque) {
		...
		Vec3<double> GetAngularVelocity() const {
			return _angularVelocity;
		}
		Vec3<double> GetAcceleration() const {
			return _acceleration;
		}
		Vec3<double> GetTorque() const {
			return _torque;
		}
